...
namespace GlobalAutoTranslator
{
	...
	public static class Prompt
	{
		public const string System =
			...
			"3. ЗАПРЕЩЕНО создавать новые плейсхолдеры. Используй только те {..} и <..>, что есть в исходной строке. " +
			"Никаких тернарных операторов, условий и конструкций вида {PAWN_gender ? a : b} — движок их не понимает.\n" +
			...
			"Для context=title сохраняй заглавную букву в начале, как в оригинале. " +
